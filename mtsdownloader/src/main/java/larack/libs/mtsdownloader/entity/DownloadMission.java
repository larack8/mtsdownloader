...
import static larack.libs.mtsdownloader.entity.DownloadFlag.COMPLETED;
import static larack.libs.mtsdownloader.entity.DownloadFlag.FAILED;
import static larack.libs.mtsdownloader.entity.DownloadFlag.STARTED;
...
public class DownloadMission {
    ...
    private MtsDownloader rxDownload;
    private String url;
    ...
    public static class Builder {
        MtsDownloader rxDownload;
        String url;
        String saveName;
        String savePath;

        public Builder setmtsdownloader(MtsDownloader rxDownload) {
